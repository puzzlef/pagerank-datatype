...
void runPagerank(const G& x, const H& xt, bool show) {
  ...
  vector<Fp16> *initFp16  = nullptr;

  // Find pagerank using 32-bit floats.
  auto a1 = pagerankFloat(xt, initFloat, {repeat});
  ...
  auto a2 = pagerankFp16(xt, initFp16, {repeat});
  auto e2 = absError(a2.ranks, a1.ranks, 0.0f);
  printf("[%09.3f ms; %03d iters.] [%.4e err.] pagerankFp16\n", a2.time, a2.iterations, e2);
